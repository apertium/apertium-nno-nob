...
complex differences in noun phrases:

\ex. Bokmål present tense passive verbs are expressed with an auxiliary in Nynorsk, while infinitive passives stay the same
\a. Boken leses ikke alltid \rightarrow Boka blir ikkje alltid lese\\
todo!

\ex. Bokmål genitives must be expressed periphrastically in Nynorsk

...
Nynorsk finite and main verb. \Last[c-d] shows that in certain
constructions, the Nynorsk subject has to occur between the auxiliary
and the finite verb (Norwegian being a V2 language). We apply a
transfer rule to the finite passive verbs\footnote{Norsk Ordbank uses

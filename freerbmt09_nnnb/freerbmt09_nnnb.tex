...
verbs\footnote{Norsk Ordbank uses one and the same entry for present
  ...
  entries; fortunately for us the OBT was already pretty good at
  disambiguating infinitives from finite verbs, regardless of voice.
...
Additionally, \emph{phrase-initial Bokmål genitives are

...
% \author{Kevin Unhammer\\  Department of Linguistics \\ University of Bergen \\  Bergen, Norway \\  {\tt  kun041@student.uib.no} \And  Trond Trosterud \\  Department of Linguistics \\  University of Tromsø \\  Tromsø, Norway \\    {\tt trond.trosterud@uit.no}}
...
\begin{table}[htdp]
\caption{{\sc Bleu} score (two reference translations), UWR and WER for Apertium and Nyno}
\begin{center}
...
the two translation programs is found in the lexicon. An unknown word rate (UWR) of 
